...
btnNewUser.addEventListener("click", v => {
    ...
    fetch('http://localhost:8080/ristorante/resources/users', {
        method: 'POST',
        headers: {
...
const visualizzaUsers = () => {
    fetch('http://localhost:8080/ristorante/resources/users/allslice', {
        method: 'GET',
        headers: {
           'Content-Type': 'application/json'
...
btnCancellaUser.addEventListener("click", v => {
    ...
    fetch('http://localhost:8080/ristorante/resources/users/' + txtUrsc.value, {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json'
        }
